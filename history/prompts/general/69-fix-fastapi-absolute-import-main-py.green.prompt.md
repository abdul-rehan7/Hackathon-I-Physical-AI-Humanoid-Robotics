---
id: 69
title: Fix FastAPI Absolute Import in main.py
stage: green
date: 2025-12-14
surface: agent
...
I've changed the import in 'api/main.py' to 'from config import settings' to fix the relative import error. Please retry starting your FastAPI server from the 'api' directory: 'uvicorn main:app --reload --port 8000'. Confirm server startup and then retest signup.

## Outcome

- ✅ Impact: Resolved the FastAPI `ImportError` by changing the relative import to an absolute import in `api/main.py`.
